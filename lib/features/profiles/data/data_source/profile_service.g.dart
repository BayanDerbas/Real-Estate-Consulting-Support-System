...
class _ProfileService implements ProfileService {
  ...
  @override
  Future<OfficeProfileModel> getOffice(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OfficeProfileModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/offices/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OfficeProfileModel _value;
    try {
      _value = OfficeProfileModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
