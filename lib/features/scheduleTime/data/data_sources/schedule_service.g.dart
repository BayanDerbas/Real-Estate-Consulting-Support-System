...
class _ScheduleService implements ScheduleService {
  ...
  Future<ScheduleTimeResponse> createSchedule(
    int expertId,
    List<ScheduleTimeRequest> body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body.map((e) => e.toJson()).toList();
    final _options = _setStreamType<ScheduleTimeResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://195.88.87.77:8000/working_times/${expertId}',
    ...
    late ScheduleTimeResponse _value;
    try {
      _value = ScheduleTimeResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
