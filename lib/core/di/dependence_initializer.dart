...
import 'package:graduation_project/features/service%20provider/data/data_source/expert_service.dart';
...
import '../../features/service provider/data/data_source/favourite_unfavorite/favourite_unfavourite_service.dart';
...
class DependenceInitializer {
  static dependenceInjection() async {
    ...
    // last edit
    Get.put(ExpertService(Get.find()));
    Get.put(ExpertRepository(Get.find()));
    //rating
    ...
    // Follow/Unfollow
    Get.lazyPut(() => Follow_UnFollow_service(Get.find()));
    Get.lazyPut(() => Follow_UnFollow_Repository(Get.find()));
    //favourite/unfavourite
    Get.lazyPut(() => Favourite_UnFavourite_Service(Get.find()));
    Get.lazyPut(() => Favourite_UnFavourite_Repository(Get.find()));
    // last edit
    Get.put(ServiceProviders_Controller(Get.find(), Get.find(), Get.find()));
    ...
    Get.put(OfficeProfilingController(profileRepository: Get.find()));
    Get.put(ExpertProfileController(profileRepository: Get.find()));
    // Notifications
